...
ref.watch(seleccionarThema.notifier).update((state) => value);
                  
                },
                itemBuilder: (context) => [

                    ...paletaColor.asMap().entries.map((entry) => PopupMenuItem(
                    value: entry.key,
                    ...
                    child: Row(
                      ...
                      Radio<int>(
                        ...
                        groupValue: themaSeleccionada, // Replace with a variable to manage state
                        onChanged: (value) {
                      ...
                      Text("${entry.hashCode}",style: TextStyle(color: entry.value),), // Display the color or its name
                      ],
                    ),
                    )),
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            if (text == "=") {
                                ...
                                ref
                                  .watch(textOperacion.notifier)
                                  .update((state) => operacion.substring(0, operacion.length - 1));
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor:
                                isOperator
                                    ? color.primary// verde para operadores
                                    : isDarkMode
